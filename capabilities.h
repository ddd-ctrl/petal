...
public:
  ...
  inline bool getCatAtts() {return catAtts_;};    ///< get whether the method can handle categorical attributes  
  inline bool getNumAtts() {return numAtts_;};   ///< get whether the method can handle numeric attributes    
...
private:
  bool catAtts_;            ///< true 如果该方法可以处理分类属性
  bool numAtts_;            ///< true 如果方法可以处理数字属性
