...
private:
  ...
  bool csu_;                  ///< symmetrical uncertainty instead of mi and conditional symmetrical uncertainty instead of cmi
  bool su_;                   ///< symmetrical uncertainty instead of mi, only for parents.
