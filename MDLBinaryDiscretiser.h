...
class MDLBinaryDiscretiser: public discretiser {
public:
	MDLBinaryDiscretiser(char*const*& argv, char*const* end) {
	};
	MDLBinaryDiscretiser() {
	};
	~MDLBinaryDiscretiser(void) {
	};

	void discretise(std::vector<NumValue> &vals,
