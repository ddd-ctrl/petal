 ...
 */
class gnb : public IncrementalLearner
{
public:
   ...
   */
  gnb(char*const*& argv, char*const* end);
...
private:  
  ...
  unsigned int noNumAtts_;  ///< the number of numeric attributes.
  ...
  std::vector<xyGaussDist> xyGaussDist_; ///< the xy Gaussian dist. for the numeric attributes.
