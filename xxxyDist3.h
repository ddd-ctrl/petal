...
#include "assert.h"
#include "utils.h"
//this is for memory constrained a2de (a2de_ms).
//this version of distribution class stores frequencies of  selected numbers of children and all parents.
//The dimension of parent has been divided to selected and unselected parts.
