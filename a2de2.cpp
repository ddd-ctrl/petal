...
//this version of a2de performs attribute selection according to user's specification.
//By default, it selects half the attributes.
//It uses the distribution class  xxxyDist2, which stores selected numbers of children and all parents.
...
static LearnerRegistrar registrar("a2de2", constructor<a2de2>);
